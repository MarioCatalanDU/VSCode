# NSGAII.py limpio y documentado para el TFG
# ==============================================================
...
# ==============================================================
from T01Optimizador import MixedVariableProblem as MixedVariableProblemCarles
...
res_carles = minimize(problem_carles, algorithm, termination=('n_gen', 20), seed=1, verbose=False)
end_time = time.time()
...
start_time = time.time()
res_fixed = minimize(problem_fixed, algorithm, termination=('n_gen', 20), seed=1, verbose=True)
end_time = time.time()
...
start_time = time.time()
res_var = minimize(problem_var, algorithm, termination=('n_gen', 20), seed=1, verbose=False)
end_time = time.time()
...
start_time = time.time()
res_ext = minimize(problem_ext, algorithm, termination=('n_gen', 20), seed=1, verbose=False)
end_time = time.time()
