# Este archivo es el núcleo de tu problema de optimización. Define cómo se calculan los objetivos, las restricciones y cómo se simula la red eléctrica offshore
